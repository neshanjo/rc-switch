...
public class EventsResource {
    ...
    public List<Event> getEvents() {
        ...
        query.select(event).orderBy(cb.asc(event.get(Event_.executionTime)));
    ...
    public Response createEvent(Event event) {
        event.setId(null); //force auto-generation of id
    ...
    @Path("{event}")
    public EventResource getEvent(@PathParam("event") Long id) {
        return new EventResource(em, id);
    }
}
